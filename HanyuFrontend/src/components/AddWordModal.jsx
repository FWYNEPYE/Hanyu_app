              ...
              <tbody>
                {rows.map((row, index) => (
                  <tr key={row.id}>
                    ...
                    <td className="p-1"><input type="text" className="w-full px-4 py-4 bg-white border border-gray-100 rounded-xl outline-none text-xs font-medium" value={row.example} onChange={(e) => handleInputChange(index, 'example', e.target.value)} placeholder="Ví dụ..." /></td>
                    <td className="p-1"><input type="text" className="w-full px-4 py-4 bg-white border border-gray-100 rounded-xl outline-none text-xs font-medium" value={row.note} onChange={(e) => handleInputChange(index, 'note', e.target.value)} placeholder="Ghi chú..." /></td>
